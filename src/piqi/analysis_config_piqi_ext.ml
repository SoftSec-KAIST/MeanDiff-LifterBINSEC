...
let print_specific_parameters_t ?opts x =
  Pervasives.print_endline (gen_specific_parameters_t x `piq ?opts)
let prerr_specific_parameters_t ?opts x =
  Pervasives.prerr_endline (gen_specific_parameters_t x `piq ?opts)

let print_specific_parameters_t_analyse_type ?opts x =
  Pervasives.print_endline (gen_specific_parameters_t_analyse_type x `piq ?opts)
let prerr_specific_parameters_t_analyse_type ?opts x =
  Pervasives.prerr_endline (gen_specific_parameters_t_analyse_type x `piq ?opts)

let print_standard_analysis ?opts x =
  Pervasives.print_endline (gen_standard_analysis x `piq ?opts)
let prerr_standard_analysis ?opts x =
  Pervasives.prerr_endline (gen_standard_analysis x `piq ?opts)

let print_generic_analysis ?opts x =
  Pervasives.print_endline (gen_generic_analysis x `piq ?opts)
let prerr_generic_analysis ?opts x =
  Pervasives.prerr_endline (gen_generic_analysis x `piq ?opts)

let print_generic_analysis_query_type ?opts x =
  Pervasives.print_endline (gen_generic_analysis_query_type x `piq ?opts)
let prerr_generic_analysis_query_type ?opts x =
  Pervasives.prerr_endline (gen_generic_analysis_query_type x `piq ?opts)

let print_generic_analysis_results ?opts x =
  Pervasives.print_endline (gen_generic_analysis_results x `piq ?opts)
let prerr_generic_analysis_results ?opts x =
  Pervasives.prerr_endline (gen_generic_analysis_results x `piq ?opts)

let print_callret_analysis_results ?opts x =
  Pervasives.print_endline (gen_callret_analysis_results x `piq ?opts)
let prerr_callret_analysis_results ?opts x =
  Pervasives.prerr_endline (gen_callret_analysis_results x `piq ?opts)

let print_callret_analysis_results_call_data ?opts x =
  Pervasives.print_endline (gen_callret_analysis_results_call_data x `piq ?opts)
let prerr_callret_analysis_results_call_data ?opts x =
  Pervasives.prerr_endline (gen_callret_analysis_results_call_data x `piq ?opts)

let print_callret_analysis_results_ret_data ?opts x =
  Pervasives.print_endline (gen_callret_analysis_results_ret_data x `piq ?opts)
let prerr_callret_analysis_results_ret_data ?opts x =
  Pervasives.prerr_endline (gen_callret_analysis_results_ret_data x `piq ?opts)

let print_callret_analysis_results_callret_labels ?opts x =
  Pervasives.print_endline (gen_callret_analysis_results_callret_labels x `piq ?opts)
let prerr_callret_analysis_results_callret_labels ?opts x =
  Pervasives.prerr_endline (gen_callret_analysis_results_callret_labels x `piq ?opts)

let print_callret_analysis_results_callret_status ?opts x =
  Pervasives.print_endline (gen_callret_analysis_results_callret_status x `piq ?opts)
let prerr_callret_analysis_results_callret_status ?opts x =
  Pervasives.prerr_endline (gen_callret_analysis_results_callret_status x `piq ?opts)

let print_po_analysis_results ?opts x =
  Pervasives.print_endline (gen_po_analysis_results x `piq ?opts)
let prerr_po_analysis_results ?opts x =
  Pervasives.prerr_endline (gen_po_analysis_results x `piq ?opts)

let print_po_analysis_results_po_data ?opts x =
  Pervasives.print_endline (gen_po_analysis_results_po_data x `piq ?opts)
let prerr_po_analysis_results_po_data ?opts x =
  Pervasives.prerr_endline (gen_po_analysis_results_po_data x `piq ?opts)

let print_po_analysis_results_po_status ?opts x =
  Pervasives.print_endline (gen_po_analysis_results_po_status x `piq ?opts)
let prerr_po_analysis_results_po_status ?opts x =
  Pervasives.prerr_endline (gen_po_analysis_results_po_status x `piq ?opts)
